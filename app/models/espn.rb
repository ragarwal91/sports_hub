class Espn < ActiveRecord::Base
  ...
  def self.mlb_info
    url = URI.escape("http://api.espn.com/v1/sports/baseball/mlb/teams?apikey=w92t52cvsppdst5du4x5av4m")
  ...
  def self.nba_info
    url = URI.escape("http://api.espn.com/v1/sports/basketball/nba/teams?apikey=w92t52cvsppdst5du4x5av4m")
    response = HTTParty.get(url)
    info = {}
    info[:espn_id] = response['sports'].first['leagues'].first['id']
    info[:teams] = response['sports'].first['leagues'].first['teams']
  ...
  def self.nfl_info
    url = URI.escape("http://api.espn.com/v1/sports/football/nfl/teams?apikey=w92t52cvsppdst5du4x5av4m")
    response = HTTParty.get(url)
    info = {}
    info[:espn_id] = response['sports'].first['leagues'].first['id']
    info[:teams] = response['sports'].first['leagues'].first['teams']
  ...
  def self.nhl_info
    url = URI.escape("http://api.espn.com/v1/sports/hockey/nhl/teams?apikey=w92t52cvsppdst5du4x5av4m")
    response = HTTParty.get(url)
    info = {}
    info[:espn_id] = response['sports'].first['leagues'].first['id']
    info[:teams] = response['sports'].first['leagues'].first['teams']
